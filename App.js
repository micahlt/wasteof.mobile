...
import { Notifications as ReactNotifications } from 'react-native-notifications';
...
const App = () => {
  ...
  const initBackgroundFetch = async () => {
    const status = await BackgroundFetch.configure(
      ...
      async taskId => {
        console.log('[BackgroundFetch] THERE WAS A FETCH', taskId);
        ReactNotifications.postLocalNotification({
